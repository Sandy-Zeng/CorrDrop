...
class InceptionV3(nn.Module):
    def __init__(self, num_classes=100,dropway='no',p=0.1):
        super().__init__()
...
def inceptionv3(num_classes=10,dropway='no',p=0.1):
    return InceptionV3(num_classes=num_classes,dropway=dropway,p=p)
